...
slug: professional-tax-state-wise-guide
meta_description: "Professional Tax is state-specific — some states charge it, some don't. Here are the states, salary slabs, the Rs 2,500 annual cap, due dates, and which states are exempt."
keywords: "professional tax state wise, professional tax slabs, PT rates India, professional tax states list, professional tax exempt states, PT due dates, professional tax Maharashtra Karnataka"
published: 2026-07-03
author: ComplianceCheck Team
canonical: https://compliancecheck.co.in/blog/professional-tax-state-wise-guide
---
