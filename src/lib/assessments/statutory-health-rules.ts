/**
 * Compliance rules for the Statutory Health Check assessment.
 * Single source of truth — used by both the PDF generator (server-side)
 * and the client-side download-buttons.tsx.
 */

export interface StatutoryHealthRule {
  questionId: string
  category: string
  requirement: string
...
export const STATUTORY_HEALTH_RULES: Record<string, StatutoryHealthRule> = {
  pf_1: {
    questionId: 'pf_1',
    ...
    actionIfCompliant:
      'Your EPFO registration is in order. Ensure annual renewal of Digital Signature Certificate (DSC) for continued portal access.',
    applicabilityNote:
      'Mandatory for establishments with 20+ employees. Voluntary registration allowed for smaller establishments.',
  },
  pf_2: {
    questionId: 'pf_2',
    category: 'Provident Fund',
    ...
    actionIfCompliant:
      'Excellent! Timely PF deposits demonstrate good governance. Continue maintaining deposit records for 6 years as per EPF Scheme para 36A.',
  },
  ...
  esi_1: {
    ...
    actionIfCompliant:
      'Your ESIC registration is compliant. Remember to file half-yearly returns (Form 6) by 11th May and 11th November.',
    applicabilityNote:
      'Mandatory for 10+ employees in notified areas. Wage ceiling: Rs.21,000/month (Rs.25,000 for PWD).',
  },
  esi_2: {
    questionId: 'esi_2',
    category: 'Employee State Insurance',
    ...
    actionIfCompliant:
      'Good compliance! Ensure IP numbers are generated for all new joiners within 10 days of joining.',
  },
  esi_3: {
    questionId: 'esi_3',
    category: 'Employee State Insurance',
    ...
    actionIfCompliant:
      'Correct wage monitoring in place. Continue monthly review of wage brackets during salary revisions.',
  },
  ...
  pt_1: {
    ...
    actionIfCompliant:
      'You have correctly identified PT applicability. Proceed with registration if in an applicable state.',
  },
  pt_2: {
    questionId: 'pt_2',
    category: 'Professional Tax',
    ...
    actionIfCompliant:
      'PTRC is in order. Renew annually if required by your state (e.g., Maharashtra requires no renewal).',
  },
  pt_3: {
    questionId: 'pt_3',
    category: 'Professional Tax',
    ...
    actionIfCompliant:
      'PT compliance maintained. File annual returns (Form IIIB in Maharashtra) by 31st May each year.',
  },
  ...
  gratuity_1: {
    ...
    penalty:
      'Simple interest at 10% p.a. from due date + up to 6 months imprisonment for default',
    actionIfNonCompliant: [
    ...
    actionIfCompliant:
      'Good practice! Regular liability tracking helps with cash flow planning. Review valuations annually with an actuary for companies with 100+ employees.',
    applicabilityNote:
      'Applies to establishments with 10+ employees. Once applicable, continues even if count falls below 10.',
  },
  gratuity_2: {
    ...
    governmentRef:
      'Payment of Gratuity Act, 1972 - Section 4A | Income Tax Act Section 36(1)(v)',
    ...
    actionIfCompliant:
      'Excellent financial planning! Review coverage adequacy annually, especially after salary revisions or new hires.',
  },
  ...
  bonus_1: {
    ...
    governmentRef:
      'Payment of Bonus Act, 1965 - Section 10 | Bonus ceiling notification 2016',
    officialLink:
      'https://labour.gov.in/sites/default/files/payment_of_bonus_act_1702.pdf',
    ...
    actionIfCompliant:
      'Compliant with bonus requirements. Document bonus calculation methodology in Form D for inspection purposes.',
    applicabilityNote:
      'Applies to establishments with 20+ employees. Employees earning basic + DA > Rs.21,000/month are NOT eligible for statutory bonus (but may receive ex-gratia).',
  },
  bonus_2: {
    questionId: 'bonus_2',
    category: 'Statutory Bonus',
    ...
    governmentRef:
      'Payment of Bonus Rules, 1975 - Rule 4 | Form A, B, C, D registers',
    ...
    actionIfCompliant:
      'Well-maintained records. Submit annual return (Form D) to local Labour Commissioner by 31st January each year.',
  },
}
