...
export default function DPDPGapAssessmentPage() {
  ...
  return (
    <div className={styles.page}>
      ...
      <LandingViewTracker assessmentType={ASSESSMENT_TYPES.DPDP} source="landing_page" />
          ...
          <div className={styles.heroGrid}>
            <div>
              ...
              <div style={{ marginTop: '16px' }}>
                <DownloadSampleReportButton assessmentType={ASSESSMENT_TYPES.DPDP} source="landing_page" />
              </div>
