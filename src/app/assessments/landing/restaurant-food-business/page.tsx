...
export default function RestaurantFoodBusinessPage() {
  ...
  return (
    <div className={styles.page}>
      <LandingSchema type={ASSESSMENT_TYPES.FOOD_BUSINESS} />
      <LandingViewTracker assessmentType={ASSESSMENT_TYPES.FOOD_BUSINESS} source="landing_page" />
          ...
          <div className={styles.heroGrid}>
            <div>
              ...
              <div style={{ marginTop: '16px' }}>
                <DownloadSampleReportButton assessmentType={ASSESSMENT_TYPES.FOOD_BUSINESS} source="landing_page" />
              </div>
            </div>
