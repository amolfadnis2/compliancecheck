    ...
    <div className={styles.page}>
      ...
      <nav className={styles.nav}>
        <div className={styles.container}>
          <div className={styles.navContent}>
            ...
            <Link 
              href="/assessments/state-wise-compliance/start" 
          ...
          <div className={styles.heroGrid}>
            <div>
              ...
              <ul className={styles.heroFeatures}>
                {[
                  "Professional Tax registration & slabs",
                  "Labour Welfare Fund rates & deadlines",
                  "Shops & Establishments Act requirements",
                  "Factory Act applicability",
                  "Contract Labour regulations",
                  "State-specific holidays & leave rules"
                ].map((feature, i) => (
                  <li key={i}>
                    <span 
            ...
            <div className={styles.heroVisual}>
              <div className={styles.visualHeader}>
                <div className={styles.visualIcon} style={{ background: `linear-gradient(135deg, ${accentColor} 0%, ${accentLight} 100%)` }}>
                  🗺️
                </div>
      ...
      <section className={styles.coverage}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p>Comprehensive state-wise compliance mapping for your business</p>
          </div>
          <div className={styles.coverageGrid} style={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
            {[
              ...
              <div key={i} className={styles.coverageCard} style={{ padding: '20px' }}>
      ...
      <section className={styles.howItWorks} style={{ background: '#F0FDFA' }}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            <h2>How It Works</h2>
            <p>Get your state-specific compliance requirements in 3 simple steps</p>
          </div>
          ...
          <div className={styles.sampleGrid}>
                ...
                {[
                  ...
                  <div key={i} style={{ 
                    ...
                    <div style={{ 
                      ...
                      fontSize: '12px',
                      fontWeight: '700',
                      background: item.status === 'required' ? 'rgba(5, 150, 105, 0.2)' :
                                  item.status === 'conditional' ? 'rgba(217, 119, 6, 0.2)' : 
                                  'rgba(156, 163, 175, 0.2)',
                      color: item.status === 'required' ? '#10B981' :
                             item.status === 'conditional' ? '#FBBF24' : '#9CA3AF'
                    }}>
            ...
            <div className={styles.sampleFeatures}>
              ...
              <ul className={styles.featureList}>
                {[
                  { title: 'Applicability Matrix', desc: 'Clear view of which laws apply to your business' },
                  { title: 'Rate Tables', desc: 'Professional Tax slabs, LWF rates for your state' },
                  { title: 'Deadline Calendar', desc: 'Monthly and annual filing deadlines' },
                  { title: 'Registration Checklist', desc: 'Required registrations with contact details' },
                  { title: 'Form Templates', desc: 'State-specific form references' },
                  { title: 'PDF Report', desc: 'Complete state compliance guide' }
                ].map((feature, i) => (
                  <li key={i}>
      ...
      <section className={styles.pricing} style={{ background: '#F0FDFA' }}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p>No subscriptions. Pay only when you need an assessment.</p>
          </div>
          <div className={styles.pricingCard} style={{ borderColor: accentColor, boxShadow: `0 4px 20px ${accentColor}20` }}>
            ...
            <ul className={styles.pricingFeatures}>
              {[
                'Complete state compliance check',
                'Applicability matrix',
                'Rate tables & slabs',
      ...
      <section className={styles.finalCta}>
        <div className={styles.container}>
          ...
          <Link href="/assessments/state-wise-compliance/start" className={styles.btnWhite}>
            Check My State →
          </Link>
        </div>
      </section>
        ...
        <div className={styles.container}>
          <div className={styles.footerContent}>
            ...
            <div className={styles.footerCopy}>
              © 2025 ComplianceCheck. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
