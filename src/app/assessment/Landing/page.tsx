    ...
    <div className={styles.page}>
            ...
            {[
              {
                ...
                desc: 'Verify registration status, contribution rates (12% employee + 12% employer), and timely deposit deadlines. Applies to establishments with 20+ employees.'
              },
              {
                title: 'ESI Status',
                desc: 'Check applicability (wages ≤₹21,000/month), contribution rates (0.75% employee + 3.25% employer), and compliance with ESIC requirements.'
              },
              {
                title: 'Professional Tax',
                desc: 'State-wise registration verification, monthly slab compliance, and payment deadlines. Varies by state with maximum ₹2,500/year.'
              },
              {
                title: 'Gratuity Act',
                desc: 'Applicability check (10+ employees), calculation verification (15 days wages × years of service), and payment timelines for eligible employees.'
              },
              {
                title: 'Bonus Act Compliance',
                desc: 'Eligibility criteria (salary ≤₹21,000), minimum bonus (8.33%), maximum bonus (20%), and calculation methodology review.'
              },
              {
                title: 'Record Keeping',
                desc: 'Verification of required registers, Form submissions, annual returns filing, and documentation compliance across all statutory requirements.'
              }
            ].map((item, i) => (
      ...
      <section className={styles.howItWorks}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            <h2>How It Works</h2>
            <p>Get your compliance status in 4 simple steps</p>
          </div>
            ...
            <div className={styles.samplePreview}>
              <div className={styles.sampleScore}>
                <div 
                  ...
                  style={{ background: `conic-gradient(${accentColor} 0% 68%, rgba(255,255,255,0.1) 68% 100%)` }}
                >
                ...
                {[
                  ...
                  <div key={i} className={styles.categoryBar}>
                    ...
                    <div className={styles.barContainer}>
                      <div 
                        className={`${styles.barFill} ${styles[cat.color]}`} 
        ...
        <div className={styles.container}>
          ...
          <div className={styles.pricingCard} style={{ borderColor: accentColor, boxShadow: `0 4px 20px ${accentColor}20` }}>
            ...
            <ul className={styles.pricingFeatures}>
              {[
                'Complete 12-question assessment',
